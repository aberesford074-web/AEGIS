...
const ACTION_ALIASES = new Map([
  ...
  ['getEbayMessages', 'getEbayConversations'],
  ['readEbayMessages', 'getEbayConversations'],
  ['listEbayMessages', 'getEbayConversations'],
  ['getEbayInbox', 'getEbayConversations'],
  ['readEbayInbox', 'getEbayConversations'],
  ['getEbayConversation', 'getEbayConversation'],
  ['draftEbayReply', 'createEbayReplyDraft'],
  ['replyToEbayMessage', 'sendEbayMessage'],
  ['sendEbayReply', 'sendEbayMessage'],
  ['getEbayOrders', 'getEbayOrders'],
  ['readEbayOrders', 'getEbayOrders'],
  ['getEbaySales', 'getEbayOrders'],
  ['getEbayAnalytics', 'getEbayAnalytics'],
  ['getEbayTraffic', 'getEbayAnalytics'],
  ['readEbayAnalytics', 'getEbayAnalytics'],
